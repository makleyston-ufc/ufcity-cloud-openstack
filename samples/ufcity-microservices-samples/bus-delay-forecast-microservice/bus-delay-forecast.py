...
url = ('https://github.com/makleyston-ufc/ufcity-cloud-computing/raw/main/samples/ufcity-ai-models-samples/toronto-bus-delay-forecast/toronto-bus-demand-forecast-model.joblib')
